...
class ValueGeneratorTest extends TestCase
{
    ...
    protected function getTestArrayMultiLine()
    {
        ...
        return [
            ...
            'expected' => file_get_contents(
                dirname(__DIR__) . '/Expected/PHP/ValueGeneratorArrayCodeResultMultiLine.txt'
            )
        ];
    }
    ...
    protected function getTestArraySingleLine()
    {
        ...
        return [
            'array' => $array,
            'expected' => file_get_contents(
                dirname(__DIR__) . '/Expected/PHP/ValueGeneratorArrayCodeResultSingleLine.txt'
            )
        ];
    }
    ...
    public function getDataTypes()
    {
        return array(
            ...
            [ValueGenerator::TYPE_BOOLEAN],
            [ValueGenerator::TYPE_CONSTANT],
            [ValueGenerator::TYPE_DOUBLE],
            [ValueGenerator::TYPE_EXPRESSION],
            [ValueGenerator::TYPE_FLOAT],
            [ValueGenerator::TYPE_INTEGER],
            [ValueGenerator::TYPE_NULL],
            [ValueGenerator::TYPE_NUMBER],
            [ValueGenerator::TYPE_OBJECT],
            [ValueGenerator::TYPE_OTHER],
    ...
    public function getDataValidConstantValues()
    {
        return array(
            ...
            ['string', ValueGenerator::TYPE_STRING],
            [false, ValueGenerator::TYPE_BOOLEAN],
            [1234, ValueGenerator::TYPE_NUMBER],
            [-123, ValueGenerator::TYPE_INTEGER],
            [3.1415, ValueGenerator::TYPE_FLOAT],
            [88888888, ValueGenerator::TYPE_DOUBLE],
            ['SORT_ASC', ValueGenerator::TYPE_CONSTANT],
            ['some string', ValueGenerator::TYPE_AUTO],
            [new Expression(null), ValueGenerator::TYPE_EXPRESSION]
        );
    }
    ...
    public function getDataInvalidConstantValues()
    {
        return array(
            ...
            [new \stdClass(), ValueGenerator::TYPE_OBJECT],
    ...
    public function getDataDetermineType()
    {
        return array(
            ...
            [false, ValueGenerator::TYPE_BOOLEAN],
            [null, ValueGenerator::TYPE_NULL],
            [-1, ValueGenerator::TYPE_INTEGER],
            [3.14, ValueGenerator::TYPE_NUMBER],
            [27041983, ValueGenerator::TYPE_INTEGER],
            [new Expression(null), ValueGenerator::TYPE_EXPRESSION],
            [new ValueGenerator(), ValueGenerator::TYPE_EXPRESSION],
            [new \stdClass(), ValueGenerator::TYPE_OBJECT],
            ['my string', ValueGenerator::TYPE_STRING],
            [fopen(__FILE__, 'r'), ValueGenerator::TYPE_OTHER],
        );
    }
    ...
    public function getDataEscapeStringValue()
    {
        return array(
            ...
            ['test\'\"', 'test\\\'\"', false],
            ['it\'s "quote"!', 'it\\\'s "quote"!', false],
            [null, "''", true],
            ['simple string', "'simple string'", true],
            ['test\'"', "'test\\'\"'", true],
            ['it\'s "quote"!', "'it\\'s \"quote\"!'", true],
        );
    }
    ...
    {
        return array(
            [true, ValueGenerator::TYPE_BOOLEAN, 'true'],
            [false, ValueGenerator::TYPE_BOOLEAN, 'false'],
            [0, ValueGenerator::TYPE_BOOLEAN, 'false'],
            [null, ValueGenerator::TYPE_NULL, 'null'],
            [1, ValueGenerator::TYPE_NUMBER, '1'],
            [-5, ValueGenerator::TYPE_INTEGER, '-5'],
            [3.14, ValueGenerator::TYPE_FLOAT, '3.14'],
            [27041983, ValueGenerator::TYPE_DOUBLE, '27041983'],
            ['0.111', ValueGenerator::TYPE_NUMBER, '0.111'],
            ['SORT_ASC', ValueGenerator::TYPE_CONSTANT, 'SORT_ASC'],
            [new Expression('123'), ValueGenerator::TYPE_EXPRESSION, '123'],
            [new Expression('"some string"'), ValueGenerator::TYPE_EXPRESSION, '"some string"'],
            ['my string', ValueGenerator::TYPE_STRING, "'my string'"],
            ["multi\nline\nstring", ValueGenerator::TYPE_STRING, "'multi\nline\nstring'"],
            ['my "string"', ValueGenerator::TYPE_STRING, "'my \"string\"'"],
            [
                $this->getTestArrayMultiLine()['array'],
                ValueGenerator::TYPE_ARRAY,
                $this->getTestArrayMultiLine()['expected']
            ],
        );
    }
    ...
    public function getDataGenerateAutoType()
    {
        return array(
            ...
            ['0.111', "'0.111'"],
            ['SORT_ASC', "'SORT_ASC'"],
            [new Expression('123'), '123'],
            [new Expression('"some string"'), '"some string"'],
            ['my string', "'my string'"],
            ["multi\nline\nstring", "'multi\nline\nstring'"],
            ['my "string"', "'my \"string\"'"],
