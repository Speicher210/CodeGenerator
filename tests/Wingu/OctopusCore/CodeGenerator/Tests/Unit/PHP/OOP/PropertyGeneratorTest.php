...
class PropertyGeneratorTest extends TestCase {
    ...
    public function testSetGetName($name) {
        $pg = $this->getMock('Wingu\OctopusCore\CodeGenerator\PHP\OOP\PropertyGenerator', null, [], 'PGNameValid', false);
        $pg->setName($name);
    ...
    public function getDataNamesInvalid() {
        return array(['  '], ['my name'], ['123name'], ['name-name'], ['n,n'], [null],
                [new \stdClass()]);
    }
    ...
    public function testSetNameInvalid($name) {
        $pg = $this->getMock('Wingu\OctopusCore\CodeGenerator\PHP\OOP\PropertyGenerator', null, [], 'PGNameInvalid', false);
        $pg->setName($name);
    }

    public function getDataValuesValid() {
        return array([null, null], [false, false], [true, true], [-1, -1], [3.14, 3.14], [SORT_ASC, SORT_ASC],
                ['my value', 'my value'], [array(1, 2, 3), array(1, 2, 3)], [new ValueGenerator('value generator'), 'value generator']);
    }
    ...
    public function testSetGetValue($value, $expected) {
        $pg = $this->getMock('Wingu\OctopusCore\CodeGenerator\PHP\OOP\PropertyGenerator', null, [], 'PGValueValid', false);
    ...
    public function testSetValueInvalid($value) {
        $pg = $this->getMock('Wingu\OctopusCore\CodeGenerator\PHP\OOP\PropertyGenerator', null, [], 'PGValueInvalid', false);
        $pg->setDefaultValue($value);
    }
    ...
    public function getDataGenerate() {
        ...
        $doc->expects($this->at(1))->method('generate')->will($this->returnValue("/**\n * Short desc.\n * \n * Long description.\n * \n * @var string Some param6.\n */"));

        return array(["public \$prop1 = 'string';", 'prop1', 'string'], ["        public \$prop2 = 'string';", 'prop2', 'string', null, null,
                2], ["public \$prop3 = 'it\\'s great';", 'prop3', "it's great"], ["public \$prop4;", 'prop4', null],
                ["/**\n *\n */\nprotected static \$prop5 = 'my string';", 'prop5', 'my string',
                        Modifiers::MODIFIER_PROTECTED | Modifiers::MODIFIER_STATIC, $doc],
                ["/**\n * Short desc.\n * \n * Long description.\n * \n * @var string Some param6.\n */\nprivate \$param6 = 'my string';",
                        'param6', 'my string', Modifiers::MODIFIER_PRIVATE, $doc]);
    }
