...
class ClassGeneratorTest extends TestCase
{
    ...
    public function getDataGenerate()
    {
        ...
        return array(
            [
                ...
                [],
                null,
                file_get_contents(dirname(__DIR__) . '/../Expected/PHP/OOP/ClassGenerator1.txt')
            ],
            [
                'c2',
                'myNamespace',
                ...
                [],
                null,
                file_get_contents(dirname(__DIR__) . '/../Expected/PHP/OOP/ClassGenerator2.txt')
            ],
            [
                'c3',
                'myNamespace',
                [],
                'myExtendedClass',
                ['\othernamespace\ie1', 'ie2'],
                $uses3,
                $constants3,
                $properties3,
                $methods3,
                $doc3,
                file_get_contents(dirname(__DIR__) . '/../Expected/PHP/OOP/ClassGenerator3.txt')
            ],
        );
    }
    ...
    public function getDataFromReflectionNotAClass()
    {
        ...
        $trait = $this->getMock(
            'Wingu\OctopusCore\Reflection\ReflectionClass',
            ['isInterface', 'isTrait'],
            [],
            '',
            false
