    ...
    public function getDataGenerate()
    {
        ...
        return array(
            [
                ...
                [],
                null,
                file_get_contents(dirname(__DIR__) . '/../Expected/PHP/OOP/InterfaceGenerator1.txt')
            ],
            [
                'i2',
                'myNamespace',
                ...
                [],
                null,
                file_get_contents(dirname(__DIR__) . '/../Expected/PHP/OOP/InterfaceGenerator2.txt')
            ],
            [
                'i3',
                'myNamespace',
                ...
                $methods3,
                $doc3,
                file_get_contents(dirname(__DIR__) . '/../Expected/PHP/OOP/InterfaceGenerator3.txt')
            ],
        );
    }
