...
class TraitGeneratorTest extends TestCase {
    ...
    public function getDataGenerate() {
        ...
        return array(
            ['t1', null, [], [], [], null, file_get_contents(dirname(__DIR__).'/../Expected/PHP/OOP/TraitGenerator1.txt')],
            ['t2', 'myNamespace', [], [], [], null, file_get_contents(dirname(__DIR__).'/../Expected/PHP/OOP/TraitGenerator2.txt')],
            ['t3', 'myNamespace', $uses3, $properties3, $methods3 , $doc3, file_get_contents(dirname(__DIR__).'/../Expected/PHP/OOP/TraitGenerator3.txt')],
        );
    }
