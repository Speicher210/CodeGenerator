...
class PropertyGenerator extends AbstractEntityGenerator
{
     ...
     * @param integer $modifiers The modifiers for the property.
     */
     ...
     *
     * @param \Wingu\OctopusCore\Reflection\ReflectionProperty $reflectionProperty The reflection of a class property.
    ...
    public static function fromReflection(ReflectionProperty $reflectionProperty)
    {
        ...
        if ($reflectionProperty->isDefault() === true) {
            $defaultValue = $reflectionProperty->getDeclaringClass()->getDefaultProperties();
            $pg->setDefaultValue($defaultValue[$reflectionProperty->getName()]);
        }
